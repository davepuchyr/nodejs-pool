    ...
    this.cleanShareDB = function() {
        ...
        async.waterfall([
            ...
            function (lastBlock, difficulty, callback) {
                ...
                //  dmjp: Why lastBlock + 1 and not just lastBlock?  NOTE: The last blockID is 1 when range()'s lowerbound is 0.
                range.range( lastBlock + 1, 0, -1 ).forEach(function (blockID) {
                // ~dmjp: Stock local_comms passed -0 to goToRange, which puked since it was interpreted as a string.
